...
import allTest4Questions from '../data/all/test4.json';
import allTest5Questions from '../data/all/test5.json';
import allTest6Questions from '../data/all/test6.json';
import allTest7Questions from '../data/all/test7.json';
import allTest8Questions from '../data/all/test8.json';
import allTest9Questions from '../data/all/test9.json';
import allTest10Questions from '../data/all/test10.json';
import allTest11Questions from '../data/all/test11.json';
...
function migrateAllTest2(db) {
  const seededTest = seedDb.tests.find((test) => test.id === 'all-test2');
  if (!seededTest) {
    return db;
  }
  ...
  const normalizedQuestions = normalizeQuestions('all', 'test2', allTest2Questions);
  db.questions = [
    ...db.questions.filter((question) => question.testId !== 'all-test2'),
    ...normalizedQuestions,
  ];
...
function migrateAllTest4(db) {
  const seededTest = seedDb.tests.find((test) => test.id === 'all-test4');
  if (!seededTest) {
    return db;
  }
  ...
  const normalizedQuestions = normalizeQuestions('all', 'test4', allTest4Questions);
  db.questions = [
    ...db.questions.filter((question) => question.testId !== 'all-test4'),
    ...normalizedQuestions,
  ];
...
function migrateAllTest5(db) {
  const seededTest = seedDb.tests.find((test) => test.id === 'all-test5');
  if (!seededTest) {
    return db;
  }
  ...
  const normalizedQuestions = normalizeQuestions('all', 'test5', allTest5Questions);
  db.questions = [
    ...db.questions.filter((question) => question.testId !== 'all-test5'),
    ...normalizedQuestions,
  ];
...
function migrateAllTest6(db) {
  const seededTest = seedDb.tests.find((test) => test.id === 'all-test6');
  if (!seededTest) {
    return db;
  }
  ...
  const migratedQuestions = normalizeQuestions('all', 'test6', allTest6Questions);
  db.questions = [
    ...db.questions.filter((question) => question.testId !== 'all-test6'),
    ...migratedQuestions,
  ];
...
function migrateAdditionalAllTests(db) {
  return [
    ['test7', allTest7Questions],
    ['test8', allTest8Questions],
    ['test9', allTest9Questions],
    ['test10', allTest10Questions],
    ['test11', allTest11Questions],
...
export function ensureDb() {
  ...
  if (existing?.categories && existing?.tests && existing?.questions) {
    ...
    const migratedAllTest4 = migrateAllTest4(migratedAllTest3);
    const migratedAllTest5 = migrateAllTest5(migratedAllTest4);
    const migratedAllTest6 = migrateAllTest6(migratedAllTest5);
    const migratedAdditionalAllTests = migrateAdditionalAllTests(migratedAllTest6);
    const migrated = migrateReasoningTest1(migratedAdditionalAllTests);
